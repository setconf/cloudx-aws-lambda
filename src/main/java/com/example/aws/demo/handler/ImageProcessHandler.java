package com.example.aws.demo.handler;
...
public class ImageProcessHandler implements RequestHandler<Map<String, Object>, APIGatewayProxyResponseEvent> {
    ...
    private static final String SNS_QUEUE_NAME = "aws-demo-uploads-notification-queue";
    private static final String TOPIC_ARN = "arn:aws:sns:us-east-1:748895695737:aws-demo-uploads-notification-topic";
